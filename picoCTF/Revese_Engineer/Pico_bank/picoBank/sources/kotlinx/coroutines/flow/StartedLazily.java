...
final class StartedLazily implements SharingStarted {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<FlowCollector<? super SharingCommand>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (this.$subscriptionCount.collect(new C00081(started, $this$flow), this) != coroutine_suspended) {
                        break;
                    } else {
        ...
        static final class C00081<T> implements FlowCollector {
            ...
            C00081(Ref.BooleanRef booleanRef, FlowCollector<? super SharingCommand> flowCollector) {
            ...
            */
            public final java.lang.Object emit(int r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) throws java.lang.Throwable {
                ...
                L4f:
                    ...
                    return r6
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.StartedLazily.AnonymousClass1.C00081.emit(int, kotlin.coroutines.Continuation):java.lang.Object");
            }
