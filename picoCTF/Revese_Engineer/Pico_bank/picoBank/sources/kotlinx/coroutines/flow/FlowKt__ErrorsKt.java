...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    public static final <T> Flow<T> m1699catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
    ...
    static final class C01161 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C01161) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
