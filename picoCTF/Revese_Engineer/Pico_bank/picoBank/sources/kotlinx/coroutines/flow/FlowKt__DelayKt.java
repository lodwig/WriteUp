...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1695debounceHG0u8IE(Flow<? extends T> flow, long timeout) {
        return FlowKt.debounce(flow, DelayKt.m1653toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1653toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
            }
        });
    }
    ...
    static final class C01152<T> extends SuspendLambda implements Function3<CoroutineScope, FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01152(long j, Flow<? extends T> flow, Continuation<? super C01152> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            C01152 c01152 = new C01152(this.$periodMillis, this.$this_sample, continuation);
            c01152.L$0 = coroutineScope;
            c01152.L$1 = flowCollector;
            return c01152.invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c01152 = this;
                    CoroutineScope $this$scopedFlow = (CoroutineScope) c01152.L$0;
                    FlowCollector downstream2 = (FlowCollector) c01152.L$1;
                    ReceiveChannel values2 = ProduceKt.produce$default($this$scopedFlow, null, -1, new FlowKt__DelayKt$sample$2$values$1(c01152.$this_sample, null), 1, null);
                    Ref.ObjectRef lastValue2 = new Ref.ObjectRef();
                    ticker = FlowKt__DelayKt.fixedPeriodTicker$default($this$scopedFlow, c01152.$periodMillis, 0L, 2, null);
                ...
                case 1:
                    c01152 = this;
                    ticker = (ReceiveChannel) c01152.L$3;
                    lastValue = (Ref.ObjectRef) c01152.L$2;
                    values = (ReceiveChannel) c01152.L$1;
                    downstream = (FlowCollector) c01152.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
            ...
            while (lastValue.element != NullSurrogateKt.DONE) {
                c01152.L$0 = downstream;
                c01152.L$1 = values;
                c01152.L$2 = lastValue;
                c01152.L$3 = ticker;
                c01152.label = 1;
                Continuation uCont$iv = c01152;
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c01152);
                }
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long periodMillis) {
        if (periodMillis > 0) {
            return FlowCoroutineKt.scopedFlow(new C01152(periodMillis, flow, null));
        }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope $this$fixedPeriodTicker, long delayMillis, long initialDelayMillis) {
        ...
        return ProduceKt.produce$default($this$fixedPeriodTicker, null, 0, new C01143(initialDelayMillis, delayMillis, null), 1, null);
    }
    ...
    static final class C01143 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01143(long j, long j2, Continuation<? super C01143> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01143 c01143 = new C01143(this.$initialDelayMillis, this.$delayMillis, continuation);
            c01143.L$0 = obj;
            return c01143;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C01143) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r8) {
            ...
            L6c:
                goto L46
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__DelayKt.C01143.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    /* renamed from: sample-HG0u8IE, reason: not valid java name */
    public static final <T> Flow<T> m1696sampleHG0u8IE(Flow<? extends T> flow, long period) {
        return FlowKt.sample(flow, DelayKt.m1653toDelayMillisLRDsOJo(period));
    }
}
