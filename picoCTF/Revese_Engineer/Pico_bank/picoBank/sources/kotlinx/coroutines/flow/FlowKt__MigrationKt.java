...
final /* synthetic */ class FlowKt__MigrationKt {
    ...
    public static final <T> Flow<T> onErrorReturn(Flow<? extends T> flow, T t, Function1<? super Throwable, Boolean> function1) {
        return FlowKt.m1692catch(flow, new AnonymousClass2(function1, t, null));
    }
    ...
    static final class C01191<T> extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $timeMillis;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01191(long j, Continuation<? super C01191> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01191(this.$timeMillis, continuation);
        }
    ...
    public static final <T> Flow<T> delayFlow(Flow<? extends T> flow, long timeMillis) {
        return FlowKt.onStart(flow, new C01191(timeMillis, null));
    }
