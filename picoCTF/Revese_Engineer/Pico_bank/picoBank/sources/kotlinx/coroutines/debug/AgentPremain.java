...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM163constructorimpl = Result.m163constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM163constructorimpl = Result.m163constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m169isFailureimpl(objM163constructorimpl) ? null : objM163constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1691installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1691installSignalHandler$lambda1(Signal it) {
