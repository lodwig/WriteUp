...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object mo1668trySendJP2dKIU(E element) {
        Object result = offerInternal(element);
        if (result == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m1688successJP2dKIU(Unit.INSTANCE);
        }
        if (result == AbstractChannelKt.OFFER_FAILED) {
            Closed closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m1687failurePtdJZtk() : ChannelResult.INSTANCE.m1686closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (result instanceof Closed) {
            return ChannelResult.INSTANCE.m1686closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        }
    ...
    */
    public final java.lang.Object sendSuspend(E r12, kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        ...
        L6f:
            ...
            java.lang.Object r8 = kotlin.Result.m163constructorimpl(r8)
            r7.resumeWith(r8)
            goto L99
        L87:
    ...
    */
    ...
    private final void helpClose(Closed<?> closed) {
        Object closedList = InlineList.m1705constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closed.getPrevNode();
            Receive previous = prevNode instanceof Receive ? (Receive) prevNode : null;
            if (previous == null) {
                break;
            } else if (!previous.mo1713remove()) {
                previous.helpRemove();
            } else {
                closedList = InlineList.m1710plusFjFbRPM(closedList, previous);
            }
        }
        if (closedList != null) {
