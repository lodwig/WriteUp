...
public interface ReceiveChannel<E> {
    ...
    Object mo1666receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1667tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1667tryReceivePtdJZtk = receiveChannel.mo1667tryReceivePtdJZtk();
            if (ChannelResult.m1683isSuccessimpl(objMo1667tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1679getOrThrowimpl(objMo1667tryReceivePtdJZtk);
            }
            Throwable thM1677exceptionOrNullimpl = ChannelResult.m1677exceptionOrNullimpl(objMo1667tryReceivePtdJZtk);
            if (thM1677exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1677exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) throws java.lang.Throwable {
            ...
            L38:
                ...
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.mo1666receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L45
                return r1
            L45:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1678getOrNullimpl(r3)
                return r3
            */
