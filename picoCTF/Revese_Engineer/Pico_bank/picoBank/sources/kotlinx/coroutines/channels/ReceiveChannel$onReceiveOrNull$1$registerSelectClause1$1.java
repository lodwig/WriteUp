...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1689invokeWpGqRn0(((ChannelResult) obj).getHolder(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0, reason: not valid java name */
    public final Object m1689invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1673boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        switch (this.label) {
            case 0:
                ...
                Throwable thM1677exceptionOrNullimpl = ChannelResult.m1677exceptionOrNullimpl(holder);
                if (thM1677exceptionOrNullimpl != null) {
                    throw thM1677exceptionOrNullimpl;
                }
                Function2<E, Continuation<? super R>, Object> function2 = this.$block;
                Object objM1678getOrNullimpl = ChannelResult.m1678getOrNullimpl(holder);
                this.label = 1;
                Object objInvoke = function2.invoke(objM1678getOrNullimpl, this);
