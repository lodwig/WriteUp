...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM163constructorimpl = Result.m163constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM163constructorimpl = Result.m163constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m169isFailureimpl(objM163constructorimpl) ? null : objM163constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1714dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1664postFrameCallback$lambda6(cancellableContinuation, j);
            }
        });
    }
    ...
    public static final void m1664postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
