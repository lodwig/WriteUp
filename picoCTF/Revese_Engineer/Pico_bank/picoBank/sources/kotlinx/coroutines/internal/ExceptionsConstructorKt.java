...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM163constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM163constructorimpl = Result.m163constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM163constructorimpl = Result.m163constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m169isFailureimpl(objM163constructorimpl)) {
                objM163constructorimpl = null;
            }
            return (E) objM163constructorimpl;
        }
            ...
            case 0:
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        it.initCause(e);
                        objM163constructorimpl = Result.m163constructorimpl(it);
                        if (Result.m169isFailureimpl(objM163constructorimpl)) {
                            objM163constructorimpl = null;
                        }
                        return (Throwable) objM163constructorimpl;
                    }
                };
            case 1:
                Class cls = p[0];
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        objM163constructorimpl = Result.m163constructorimpl((Throwable) objNewInstance);
                        if (Result.m169isFailureimpl(objM163constructorimpl)) {
                            objM163constructorimpl = null;
                        }
                        return (Throwable) objM163constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM163constructorimpl = Result.m163constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM163constructorimpl = Result.m163constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM163constructorimpl = Result.m163constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM163constructorimpl = Result.m163constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m169isFailureimpl(objM163constructorimpl)) {
            objM163constructorimpl = numValueOf;
        }
        return ((Number) objM163constructorimpl).intValue();
    }
