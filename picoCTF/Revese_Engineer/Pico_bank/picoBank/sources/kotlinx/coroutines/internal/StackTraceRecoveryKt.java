...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM163constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM163constructorimpl = Result.m163constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM163constructorimpl = Result.m163constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m166exceptionOrNullimpl(objM163constructorimpl) == null) {
            obj2 = objM163constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM163constructorimpl2 = Result.m163constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM163constructorimpl2 = Result.m163constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m166exceptionOrNullimpl(objM163constructorimpl2) == null) {
            obj = objM163constructorimpl2;
        }
