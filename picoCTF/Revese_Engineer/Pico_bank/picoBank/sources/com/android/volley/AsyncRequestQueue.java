...
public class AsyncRequestQueue extends RequestQueue {
    ...
    private class CacheParseTask<T> extends RequestTask<T> {
        ...
        public void run() {
            ...
            Response<T> networkResponse = this.mRequest.parseNetworkResponse(new NetworkResponse(ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION, this.entry.data, false, 0L, this.entry.allResponseHeaders));
