...
class SearchBarAnimationHelper {
    ...
    void startExpandAnimation(final SearchBar searchBar, final View expandedView, final AppBarLayout appBarLayout, final boolean skipAnimation) {
        ...
        expandedView.post(new Runnable() { // from class: com.google.android.material.search.SearchBarAnimationHelper$$ExternalSyntheticLambda3
            ...
            public final void run() {
                this.f$0.m123x1b96b119(searchBar, expandedView, appBarLayout, skipAnimation);
            }
        });
    }
    ...
    /* synthetic */ void m123x1b96b119(SearchBar searchBar, View expandedView, AppBarLayout appBarLayout, boolean skipAnimation) {
