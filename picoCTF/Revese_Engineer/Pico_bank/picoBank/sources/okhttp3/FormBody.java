...
public final class FormBody extends RequestBody {
    ...
    public final int m1767deprecated_size() {
        return size();
    }
    ...
    public static final class Builder {
        ...
        public final Builder add(String name, String value) {
            ...
            $this$apply.names.add(HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.FORM_ENCODE_SET, false, false, true, false, $this$apply.charset, 91, null));
            $this$apply.values.add(HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, value, 0, 0, HttpUrl.FORM_ENCODE_SET, false, false, true, false, $this$apply.charset, 91, null));
            return this;
        }
        ...
        public final Builder addEncoded(String name, String value) {
            ...
            Intrinsics.checkNotNullParameter(value, "value");
            Builder $this$apply = this;
            $this$apply.names.add(HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, name, 0, 0, HttpUrl.FORM_ENCODE_SET, true, false, true, false, $this$apply.charset, 83, null));
            $this$apply.values.add(HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.INSTANCE, value, 0, 0, HttpUrl.FORM_ENCODE_SET, true, false, true, false, $this$apply.charset, 83, null));
            return this;
        }
