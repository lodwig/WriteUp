...
public final class Handshake {
    ...
    public final List<Certificate> m1771deprecated_peerCertificates() {
    ...
    public final Principal m1772deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m1769deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m1770deprecated_localPrincipal() {
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = new StringBuilder().append("Handshake{").append("tlsVersion=").append(this.tlsVersion).append(' ').append("cipherSuite=").append(this.cipherSuite).append(' ').append("peerCertificates=").append(peerCertificatesString).append(' ').append("localCertificates=");
    ...
    public static final class Companion {
        ...
        */
        ...
        public final Handshake m1774deprecated_get(SSLSession sslSession) throws IOException {
