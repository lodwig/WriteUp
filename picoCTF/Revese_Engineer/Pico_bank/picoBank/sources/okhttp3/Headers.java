...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m1775deprecated_size() {
        return size();
    }
    ...
    public static final class Companion {
        ...
        public final Headers of(String... namesAndValues) throws CloneNotSupportedException {
            ...
            IntProgression intProgressionStep = RangesKt.step(ArraysKt.getIndices(namesAndValues2), 2);
            int i2 = intProgressionStep.getFirst();
            int last = intProgressionStep.getLast();
            int step = intProgressionStep.getStep();
        ...
        public final Headers m1777deprecated_of(String... namesAndValues) {
            Intrinsics.checkNotNullParameter(namesAndValues, "namesAndValues");
        ...
        /* renamed from: -deprecated_of, reason: not valid java name */
        public final Headers m1776deprecated_of(Map<String, String> headers) {
            Intrinsics.checkNotNullParameter(headers, "headers");
            return of(headers);
        }
