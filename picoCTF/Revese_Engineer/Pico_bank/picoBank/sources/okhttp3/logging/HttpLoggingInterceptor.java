...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws Exception {
        ...
        if (logHeaders) {
            ...
            if (requestBody != null) {
                MediaType it = requestBody.get$contentType();
                if (it != null && headers.get(HttpHeaderParser.HEADER_CONTENT_TYPE) == null) {
            ...
            if (!logBody || requestBody == null) {
                ...
                MediaType contentType = requestBody.get$contentType();
        ...
        try {
            ...
            StringBuilder sbAppend = new StringBuilder().append("<-- ").append(response.code());
            ...
            logger.log(sbAppend.append(str4).append(c).append(response.request().url()).append(" (").append(tookMs).append("ms").append(!logHeaders ? ", " + bodySize + " body" : str2).append(')').toString());
            if (logHeaders) {
