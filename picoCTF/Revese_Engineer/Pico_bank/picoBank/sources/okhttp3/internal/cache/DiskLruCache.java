...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final BufferedSink newJournalWriter() throws FileNotFoundException {
        ...
        FaultHidingSink faultHidingSink = new FaultHidingSink(fileSink, new Function1<IOException, Unit>() { // from class: okhttp3.internal.cache.DiskLruCache$newJournalWriter$faultHidingSink$1
            ...
            public final void invoke2(IOException it) {
                ...
                Thread threadCurrentThread = Thread.currentThread();
                Intrinsics.checkNotNullExpressionValue(threadCurrentThread, "Thread.currentThread()");
                throw new AssertionError(sbAppend.append(threadCurrentThread.getName()).append(" MUST hold lock on ").append($this$assertThreadHoldsLock$iv).toString());
            }
        });
    ...
    public final class Editor {
        ...
        public Editor(DiskLruCache this$0, Entry entry) {
            ...
            this.this$0 = this$0;
            this.entry = entry;
            this.written = this.entry.getReadable() ? null : new boolean[this$0.getValueCount()];
        }
