...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte getByte(long pos) {
        ...
        while (true) {
            ...
            if (nextOffset$iv$iv > pos) {
                ...
                return s$iv3.data[(int) ((s$iv3.pos + pos) - offset$iv2)];
            }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:44:0x00c1 A[EDGE_INSN: B:44:0x00c1->B:38:0x00c1 BREAK  A[LOOP:0: B:5:0x0011->B:46:?], SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public long readHexadecimalUnsignedLong() throws java.io.EOFException {
        ...
        L8d:
            ...
            java.lang.String r14 = okio.Util.toHexString(r13)
            java.lang.StringBuilder r5 = r5.append(r14)
    ...
    public void write(Buffer source, long byteCount) {
        ...
        while (byteCount$iv > 0) {
            ...
            if (this.head == null) {
                ...
                Segment tail$iv2 = segment5.prev;
    ...
    public long indexOf(byte b, long fromIndex, long toIndex) {
        ...
        while (offset$iv4 < toIndex$iv) {
            ...
            int $i$f$seek3 = s$iv5.pos;
            Segment s$iv$iv2 = s$iv$iv;
            int limit$iv2 = (int) Math.min(j, ($i$f$seek3 + toIndex$iv) - offset$iv4);
    ...
    public final byte m1863deprecated_getByte(long index) {
    ...
    /* compiled from: Buffer.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0010\u001a\u00020\u0011H\u0016J\u000e\u0010\u0012\u001a\u00020\n2\u0006\u0010\u0013\u001a\u00020\bJ\u0006\u0010\u0014\u001a\u00020\bJ\u000e\u0010\u0015\u001a\u00020\n2\u0006\u0010\u0016\u001a\u00020\nJ\u000e\u0010\u0017\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u0014\u0010\u0003\u001a\u0004\u0018\u00010\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00068\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\n8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000b\u001a\u00020\f8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u0004\u0018\u00010\u000eX\u0082\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000f\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u0018"}, d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "()V", "buffer", "Lokio/Buffer;", "data", "", "end", "", TypedValues.CycleType.S_WAVE_OFFSET, "", "readWrite", "", "segment", "Lokio/Segment;", "start", "close", "", "expandBuffer", "minByteCount", "next", "resizeBuffer", "newSize", "seek", "okio"}, k = 1, mv = {1, 4, 0})
    public static final class UnsafeCursor implements Closeable {
        ...
        public final int seek(long offset) {
            ...
            if (this.segment != null) {
                ...
                long segmentOffset = j - (i - r13.pos);
