...
public final class buffer implements BufferedSource {
    ...
    public int select(okio.Options r10) {
        ...
        Le:
            ...
            int r2 = okio.internal.BufferKt.selectPrefix(r2, r10, r3)
            r4 = -1
            switch(r2) {
                case -2: goto L2f;
                case -1: goto L2d;
    ...
    public long readHexadecimalUnsignedLong() throws EOFException {
        ...
        for (int pos$iv = 0; request(pos$iv + 1); pos$iv++) {
            byte b$iv = this.bufferField.getByte(pos$iv);
            if ((b$iv < ((byte) 48) || b$iv > ((byte) 57)) && ((b$iv < ((byte) 97) || b$iv > ((byte) LocationRequestCompat.QUALITY_BALANCED_POWER_ACCURACY)) && (b$iv < ((byte) 65) || b$iv > ((byte) 70)))) {
                if (pos$iv == 0) {
