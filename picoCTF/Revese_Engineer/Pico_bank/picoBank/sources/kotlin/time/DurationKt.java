...
public final class DurationKt {
    ...
    private static final long m1615timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1527timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1614timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1526timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1489constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1489constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1489constructorimpl((normalValue << 1) + unitDiscriminator);
    }
