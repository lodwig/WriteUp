...
public final class Duration implements Comparable<Duration> {
    ...
    public static final class Companion {
        ...
        public final Duration m1610parseOrNullFghU774(String value) {
            Intrinsics.checkNotNullParameter(value, "value");
            try {
                return Duration.m1487boximpl(DurationKt.parseDuration(value, false));
            } catch (IllegalArgumentException e) {
                return null;
            }
        }
        ...
        public final Duration m1609parseIsoStringOrNullFghU774(String value) {
            Intrinsics.checkNotNullParameter(value, "value");
            try {
                return Duration.m1487boximpl(DurationKt.parseDuration(value, true));
            } catch (IllegalArgumentException e) {
                return null;
            }
        }
    ...
    public static final long m1541unaryMinusUwyO8pc(long arg0) {
        return DurationKt.durationOf(-m1516getValueimpl(arg0), ((int) arg0) & 1);
    }
    ...
    public static final long m1525plusLRDsOJo(long arg0, long other) {
        ...
        if ((((int) arg0) & 1) == (((int) other) & 1)) {
            ...
            return m1520isInNanosimpl(arg0) ? DurationKt.durationOfNanosNormalized(result) : DurationKt.durationOfMillisNormalized(result);
        }
    ...
    public static final long m1492divUwyO8pc(long arg0, int scale) {
        ...
        if (m1520isInNanosimpl(arg0)) {
            return DurationKt.durationOfNanos(m1516getValueimpl(arg0) / scale);
        }
        if (m1521isInfiniteimpl(arg0)) {
        ...
        if (new LongRange(-4611686018426L, 4611686018426L).contains(result)) {
            long rem = DurationKt.millisToNanos(m1516getValueimpl(arg0) - (scale * result)) / scale;
    ...
    public static final int m1512getNanosecondsComponentimpl(long arg0) {
        ...
        if (m1519isInMillisimpl(arg0)) {
            return (int) DurationKt.millisToNanos(m1516getValueimpl(arg0) % 1000);
        }
        return (int) (m1516getValueimpl(arg0) % Http2Connection.DEGRADED_PONG_TIMEOUT_NS);
    }
    ...
    public static String m1538toStringimpl(long arg0) {
        ...
        if (hasSeconds) {
            ...
            if (seconds != 0 || hasDays || hasHours || hasMinutes) {
                ...
                m1486appendFractionalimpl(arg0, $this$toString_impl_u24lambda_u245, seconds, nanoseconds2, 9, "s", false);
                components = components4;
            } else {
                if (nanoseconds >= 1000000) {
                    m1486appendFractionalimpl(arg0, $this$toString_impl_u24lambda_u245, nanoseconds / DurationKt.NANOS_IN_MILLIS, nanoseconds % DurationKt.NANOS_IN_MILLIS, 6, "ms", false);
                } else if (nanoseconds >= 1000) {
                    m1486appendFractionalimpl(arg0, $this$toString_impl_u24lambda_u245, nanoseconds / 1000, nanoseconds % 1000, 3, "us", false);
                } else {
