    ...
    public final void resumeWith(Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                objM163constructorimpl = Result.m163constructorimpl(ResultKt.createFailure(exception));
            }
            if (outcome == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            Result.Companion companion2 = Result.INSTANCE;
            objM163constructorimpl = Result.m163constructorimpl(outcome);
            Object outcome2 = objM163constructorimpl;
