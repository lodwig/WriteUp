...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00451<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C00451(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> function0, Continuation<? super C00451> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00451 c00451 = new C00451(this.$this_ifEmpty, this.$defaultValue, continuation);
            c00451.L$0 = obj;
            return c00451;
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> sequence, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00451(sequence, defaultValue, null));
    }
    ...
    static final class C00461<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00461(Sequence<? extends T> sequence, Random random, Continuation<? super C00461> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00461 c00461 = new C00461(this.$this_shuffled, this.$random, continuation);
            c00461.L$0 = obj;
            return c00461;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(SequenceScope<? super T> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C00461) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ResultKt.throwOnFailure(obj);
                    c00461 = this;
                    sequenceScope = (SequenceScope) c00461.L$0;
                    mutableList = SequencesKt.toMutableList(c00461.$this_shuffled);
                    break;
                case 1:
                    c00461 = this;
                    mutableList = (List) c00461.L$1;
                    sequenceScope = (SequenceScope) c00461.L$0;
                    ResultKt.throwOnFailure(obj);
                    break;
                default:
            ...
            while (!mutableList.isEmpty()) {
                int iNextInt = c00461.$random.nextInt(mutableList.size());
                ...
                c00461.L$0 = sequenceScope;
                c00461.L$1 = mutableList;
                c00461.label = 1;
                if (sequenceScope.yield(t, c00461) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> sequence, Random random) {
        ...
        return SequencesKt.sequence(new C00461(sequence, random, null));
    }
    ...
    static final class C00411<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C00411(Sequence<? extends T> sequence, Function2<? super Integer, ? super T, ? extends C> function2, Function1<? super C, ? extends Iterator<? extends R>> function1, Continuation<? super C00411> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C00411 c00411 = new C00411(this.$source, this.$transform, this.$iterator, continuation);
            c00411.L$0 = obj;
            return c00411;
        }
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00411 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c00411.L$0;
                    $this$sequence = $this$sequence2;
                    index = 0;
                    it = c00411.$source.iterator();
                    break;
                case 1:
                    c00411 = this;
                    index = c00411.I$0;
                    it = (Iterator) c00411.L$1;
                    $this$sequence = (SequenceScope) c00411.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            while (it.hasNext()) {
                ...
                Function2<Integer, T, C> function2 = c00411.$transform;
                int index2 = index + 1;
                if (index < 0) {
                    CollectionsKt.throwIndexOverflow();
                }
                Object result = function2.invoke(Boxing.boxInt(index), element);
                c00411.L$0 = $this$sequence;
                c00411.L$1 = it;
                c00411.I$0 = index2;
                c00411.label = 1;
                if ($this$sequence.yieldAll(c00411.$iterator.invoke(result), c00411) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                index = index2;
            }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        Intrinsics.checkNotNullParameter(iterator, "iterator");
        return SequencesKt.sequence(new C00411(source, transform, iterator, null));
    }
