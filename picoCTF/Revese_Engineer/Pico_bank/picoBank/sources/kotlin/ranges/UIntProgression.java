...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) UInt.m304toStringimpl(this.first)).append("..").append((Object) UInt.m304toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) UInt.m304toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m304toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
