...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        return (((((int) ULong.m337constructorimpl(this.first ^ ULong.m337constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m337constructorimpl(this.last ^ ULong.m337constructorimpl(this.last >>> 32)))) * 31) + ((int) (this.step ^ (this.step >>> 32)));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m383toStringimpl(this.first)).append("..").append((Object) ULong.m383toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m383toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m383toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1408fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
