...
public final class UStringsKt {
    ...
    public static final String m1475toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1477toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1476toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1474toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m258constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m175boximpl(UByte.m181constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m258constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m438boximpl(UShort.m444constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m258constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m258constructorimpl(result * uradix);
            result = UInt.m258constructorimpl(UInt.m258constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m252boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m337constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m337constructorimpl(result * uradix);
            result = ULong.m337constructorimpl(ULong.m337constructorimpl(UInt.m258constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m331boximpl(result);
    }
}
