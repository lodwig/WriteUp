    ...
    public final R runCallLoop() throws Throwable {
        while (true) {
            ...
            if (continuation != null) {
                if (!Result.m165equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                    this.result = DeepRecursiveKt.UNDEFINED_RESULT;
                    ...
                    try {
                        ...
                        if (objInvoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m163constructorimpl(objInvoke));
                        }
                    } catch (Throwable th) {
                        Result.Companion companion2 = Result.INSTANCE;
                        continuation.resumeWith(Result.m163constructorimpl(ResultKt.createFailure(th)));
                    }
                }
            } else {
