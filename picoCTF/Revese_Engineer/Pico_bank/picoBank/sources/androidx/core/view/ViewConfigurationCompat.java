...
public final class ViewConfigurationCompat {
    ...
    private static int getCompatFlingVelocityThreshold(Resources res, int platformResId, Supplier<Integer> defaultThresholdSupplier, int noFlingThreshold) throws Resources.NotFoundException {
