...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void onConfigurationChanged(Configuration newConfig) throws IllegalAccessException, PackageManager.NameNotFoundException, IllegalArgumentException {
        ActionBar ab;
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void onStart() throws IllegalAccessException, PackageManager.NameNotFoundException, IllegalArgumentException {
    ...
    */
    ...
    public View createView(View view, String name, Context context, AttributeSet attrs) {
        ...
        if (IS_PRE_LOLLIPOP) {
            ...
            if (this.mLayoutIncludeDetector.detect(attrs)) {
                ...
                inheritContext = zShouldInheritContext;
            }
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    final int updateStatusGuard(androidx.core.view.WindowInsetsCompat r18, android.graphics.Rect r19) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        /*
    ...
    private boolean applyApplicationSpecificConfig(boolean allowRecreation, boolean isLocalesApplicationRequired) throws IllegalAccessException, PackageManager.NameNotFoundException, IllegalArgumentException {
        if (this.mDestroyed) {
            return false;
        }
    ...
    private boolean updateAppConfiguration(int nightMode, LocaleListCompat locales, boolean allowRecreation) throws IllegalAccessException, PackageManager.NameNotFoundException, IllegalArgumentException {
    ...
    private void updateResourcesConfiguration(int uiModeNightModeValue, LocaleListCompat locales, boolean callOnConfigChange, Configuration configOverlay) throws IllegalAccessException, IllegalArgumentException {
    ...
    private int getActivityHandlesConfigChangesFlags(Context baseContext) throws PackageManager.NameNotFoundException {
        int flags;
