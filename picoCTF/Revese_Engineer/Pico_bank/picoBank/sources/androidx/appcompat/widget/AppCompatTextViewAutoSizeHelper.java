...
class AppCompatTextViewAutoSizeHelper {
    ...
    private void setRawTextSize(float size) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    static <T> T invokeAndReturnWithDefault(Object object, String methodName, T defaultValue) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        T result = null;
