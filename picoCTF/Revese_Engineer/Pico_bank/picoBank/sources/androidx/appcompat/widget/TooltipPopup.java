...
class TooltipPopup {
    ...
    void show(View anchorView, int anchorX, int anchorY, boolean fromTouch, CharSequence tooltipText) throws Resources.NotFoundException {
        if (isShowing()) {
            hide();
        }
    ...
    private void computePosition(View anchorView, int anchorX, int anchorY, boolean fromTouch, WindowManager.LayoutParams outParams) throws Resources.NotFoundException {
        int offsetX;
        int offsetBelow;
        int offsetExtra;
        int statusBarHeight;
