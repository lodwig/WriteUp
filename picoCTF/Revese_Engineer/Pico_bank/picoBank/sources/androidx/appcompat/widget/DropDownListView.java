...
class DropDownListView extends ListView {
    ...
    private void superSetSelectedChildViewEnabled(boolean enabled) throws IllegalAccessException, IllegalArgumentException {
        if (Build.VERSION.SDK_INT >= 33) {
    ...
    @Override // android.view.View
    public boolean onHoverEvent(MotionEvent ev) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public boolean onForwardedEvent(MotionEvent event, int activePointerId) throws IllegalAccessException, IllegalArgumentException {
    ...
    private void positionSelectorLikeTouchCompat(int position, View sel, float x, float y) throws IllegalAccessException, IllegalArgumentException {
    ...
    private void positionSelectorLikeFocusCompat(int position, View sel) throws IllegalAccessException, IllegalArgumentException {
        Drawable selector = getSelector();
    ...
    private void positionSelectorCompat(int position, View sel) throws IllegalAccessException, IllegalArgumentException {
    ...
    private void setPressedItem(View child, int position, float x, float y) throws IllegalAccessException, IllegalArgumentException {
        View motionView;
    ...
    static class Api30Impl {
        ...
        static void positionSelectorForHoveredItem(DropDownListView view, int position, View sel) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            try {
    ...
    static class PreApi33Impl {
        ...
        static void setSelectedChildViewEnabled(AbsListView view, boolean enabled) throws IllegalAccessException, IllegalArgumentException {
            if (sIsChildViewEnabled != null) {
                try {
