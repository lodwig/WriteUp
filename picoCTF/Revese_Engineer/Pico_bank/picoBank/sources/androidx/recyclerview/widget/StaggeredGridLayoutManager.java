            ...
            if (layoutState.hasMore(state)) {
                ...
                if (layoutState.mLayoutDirection == r10) {
                    if (layoutParams.mFullSpan) {
                        decoratedMeasurement2 = getMaxEnd(i3);
                    } else {
                        decoratedMeasurement2 = span.getEndLine(i3);
                    }
                    decoratedMeasurement = this.mPrimaryOrientation.getDecoratedMeasurement(next) + decoratedMeasurement2;
                    if (z3 && layoutParams.mFullSpan) {
                        LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromEnd = createFullSpanItemFromEnd(decoratedMeasurement2);
                    ...
                    if (layoutParams.mFullSpan) {
                        startLine = getMinStart(i3);
                    } else {
                        startLine = span.getStartLine(i3);
                    }
                    decoratedMeasurement = startLine;
                    decoratedMeasurement2 = decoratedMeasurement - this.mPrimaryOrientation.getDecoratedMeasurement(next);
                    if (z3 && layoutParams.mFullSpan) {
                        LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromStart = createFullSpanItemFromStart(decoratedMeasurement);
                        fullSpanItemCreateFullSpanItemFromStart.mGapDir = r10;
                ...
                if (isLayoutRTL() && this.mOrientation == r10) {
                    ...
                    decoratedMeasurement4 = endAfterPadding - this.mSecondaryOrientation.getDecoratedMeasurement(next);
                } else {
                    if (layoutParams.mFullSpan) {
                    ...
                    int i6 = startAfterPadding2;
                    decoratedMeasurement3 = this.mSecondaryOrientation.getDecoratedMeasurement(next) + i6;
                    decoratedMeasurement4 = i6;
                }
                if (this.mOrientation == r10) {
                    span2 = span;
                    layoutDecoratedWithMargins(next, decoratedMeasurement4, i4, decoratedMeasurement3, i5);
                } else {
                    span2 = span;
                    layoutDecoratedWithMargins(next, i4, decoratedMeasurement4, i5, decoratedMeasurement3);
                }
                if (layoutParams.mFullSpan) {
