...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public void mo1680dispatch(CoroutineContext context, Runnable block) {
    ...
    public void mo1681scheduleResumeAfterDelay(long timeMillis, final CancellableContinuation<? super Unit> continuation) {
        ...
        if (this.handler.postDelayed(block, RangesKt.coerceAtMost(timeMillis, DurationKt.MAX_MILLIS))) {
            return new DisposableHandle() { // from class: kotlinx.coroutines.android.HandlerContext$$ExternalSyntheticLambda0
                ...
                public final void dispose() {
                    HandlerContext.m1629invokeOnTimeout$lambda3(this.f$0, block);
                }
            };
        }
        cancelOnRejection(context, block);
    ...
    public static final void m1629invokeOnTimeout$lambda3(HandlerContext this$0, Runnable $block) {
    ...
    private final void cancelOnRejection(CoroutineContext context, Runnable block) {
        ...
        Dispatchers.getIO().mo1680dispatch(context, block);
    }
