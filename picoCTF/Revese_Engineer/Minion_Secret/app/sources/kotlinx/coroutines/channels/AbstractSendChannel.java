...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object mo1634trySendJP2dKIU(E element) {
        Object result = offerInternal(element);
        if (result == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m1654successJP2dKIU(Unit.INSTANCE);
        }
        if (result == AbstractChannelKt.OFFER_FAILED) {
            Closed closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m1653failurePtdJZtk() : ChannelResult.INSTANCE.m1652closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (result instanceof Closed) {
            return ChannelResult.INSTANCE.m1652closedJP2dKIU(helpCloseAndGetSendException((Closed) result));
        }
    ...
    */
    public final java.lang.Object sendSuspend(E r12, kotlin.coroutines.Continuation<? super kotlin.Unit> r13) {
        /*
            ...
            r5 = 0
        Lf:
            boolean r6 = access$isFullImpl(r11)
            if (r6 == 0) goto L6f
            kotlin.jvm.functions.Function1<E, kotlin.Unit> r6 = r11.onUndeliveredElement
            if (r6 != 0) goto L20
        ...
        L20:
            ...
            kotlin.jvm.functions.Function1<E, kotlin.Unit> r7 = r11.onUndeliveredElement
            r6.<init>(r12, r4, r7)
        ...
        L29:
            ...
            java.lang.Object r7 = r11.enqueueSend(r7)
            if (r7 != 0) goto L3b
            r8 = r6
        ...
        L3b:
            ...
            access$helpCloseAndResumeWithSendException(r11, r8, r12, r9)
            goto L99
        L49:
        ...
        L52:
            ...
            r9.<init>()
            java.lang.String r10 = "enqueueSend returned "
        ...
        L87:
            ...
            access$helpCloseAndResumeWithSendException(r11, r7, r12, r8)
        L99:
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (it = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m129constructorimpl(ResultKt.createFailure(it)));
        } else {
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m129constructorimpl(ResultKt.createFailure(sendException)));
        }
    }
    ...
    */
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> handler) {
        ...
        if (closedToken != null && AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(onCloseHandler$FU, this, handler, AbstractChannelKt.HANDLER_INVOKED)) {
            handler.invoke(closedToken.closeCause);
        }
    }

    private final void helpClose(Closed<?> closed) {
        Object closedList = InlineList.m1671constructorimpl$default(null, 1, null);
        while (true) {
            LockFreeLinkedListNode prevNode = closed.getPrevNode();
            Receive previous = prevNode instanceof Receive ? (Receive) prevNode : null;
            if (previous == null) {
                break;
            } else if (!previous.mo1679remove()) {
                previous.helpRemove();
            } else {
                closedList = InlineList.m1676plusFjFbRPM(closedList, previous);
            }
        }
        if (closedList != null) {
