...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object $this$toResult) {
        return $this$toResult instanceof Closed ? ChannelResult.INSTANCE.m1652closedJP2dKIU(((Closed) $this$toResult).closeCause) : ChannelResult.INSTANCE.m1654successJP2dKIU($this$toResult);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.INSTANCE.m1652closedJP2dKIU(closed.closeCause);
    }
}
