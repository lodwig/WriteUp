...
public interface SendChannel<E> {
    ...
    Object mo1634trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1634trySendJP2dKIU(e);
            if (ChannelResult.m1649isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1643exceptionOrNullimpl = ChannelResult.m1643exceptionOrNullimpl(result);
