...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        ...
        try {
            ...
            objM129constructorimpl = Result.m129constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
        ...
        if (Result.m132exceptionOrNullimpl(objM129constructorimpl) != null) {
            objM129constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) objM129constructorimpl;
    }
