...
final /* synthetic */ class FlowKt__EmittersKt {
    ...
    public static final class AnonymousClass1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    this.label = 1;
                    if (this.$this_transform.collect(new C00051(this.$transform, $this$flow), this) != coroutine_suspended) {
                        break;
                    } else {
        ...
        public final Object invokeSuspend$$forInline(Object $result) {
            FlowCollector $this$flow = (FlowCollector) this.L$0;
            InlineMarker.mark(0);
            this.$this_transform.collect(new C00051(this.$transform, $this$flow), this);
            InlineMarker.mark(1);
            return Unit.INSTANCE;
        }
    }
