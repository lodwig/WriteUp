...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM129constructorimpl = Result.m129constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM129constructorimpl = Result.m129constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m135isFailureimpl(objM129constructorimpl) ? null : objM129constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1657installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1657installSignalHandler$lambda1(Signal it) {
