...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM129constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM129constructorimpl = Result.m129constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM129constructorimpl = Result.m129constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m132exceptionOrNullimpl(objM129constructorimpl) == null) {
            obj2 = objM129constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM129constructorimpl2 = Result.m129constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM129constructorimpl2 = Result.m129constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m132exceptionOrNullimpl(objM129constructorimpl2) == null) {
            obj = objM129constructorimpl2;
        }
