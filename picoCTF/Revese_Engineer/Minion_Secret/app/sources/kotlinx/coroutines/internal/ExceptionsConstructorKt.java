...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM129constructorimpl = Result.m129constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM129constructorimpl = Result.m129constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m135isFailureimpl(objM129constructorimpl)) {
                objM129constructorimpl = null;
            }
            return (E) objM129constructorimpl;
        }
            ...
            case 0:
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        it.initCause(e);
                        objM129constructorimpl = Result.m129constructorimpl(it);
                        if (Result.m135isFailureimpl(objM129constructorimpl)) {
                            objM129constructorimpl = null;
                        }
                        return (Throwable) objM129constructorimpl;
                    }
                };
            case 1:
                Class cls = p[0];
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        objM129constructorimpl = Result.m129constructorimpl((Throwable) objNewInstance);
                        if (Result.m135isFailureimpl(objM129constructorimpl)) {
                            objM129constructorimpl = null;
                        }
                        return (Throwable) objM129constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM129constructorimpl = Result.m129constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM129constructorimpl = Result.m129constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM129constructorimpl = Result.m129constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM129constructorimpl = Result.m129constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m135isFailureimpl(objM129constructorimpl)) {
            objM129constructorimpl = numValueOf;
        }
        return ((Number) objM129constructorimpl).intValue();
    }
