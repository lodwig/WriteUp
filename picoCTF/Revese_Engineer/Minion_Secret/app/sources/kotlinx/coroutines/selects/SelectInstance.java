        ...
        while (true) {
            ...
            if (result$iv == SelectKt.UNDECIDED) {
                ...
                if (result$iv == update$iv2) {
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                        if (Result.m135isFailureimpl(result)) {
                            Continuation $this$resumeWithStackTrace$iv = this.uCont;
                            Throwable exception$iv = Result.m132exceptionOrNullimpl(result);
                            ...
                            $this$resumeWithStackTrace$iv.resumeWith(Result.m129constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame)));
                            return;
                        }
            ...
            if (result$iv == SelectKt.UNDECIDED) {
                ...
                if (result$iv == update$iv2) {
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.RESUMED)) {
                        ...
                        Result.Companion companion = Result.INSTANCE;
                        continuationIntercepted.resumeWith(Result.m129constructorimpl(ResultKt.createFailure(exception)));
                        return;
                    }
                } else {
                    throw new IllegalStateException("Already resumed");
