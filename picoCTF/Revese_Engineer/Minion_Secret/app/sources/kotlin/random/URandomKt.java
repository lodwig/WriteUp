...
public final class URandomKt {
    ...
    public static final int m1360nextUIntqCasIEU(Random nextUInt, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        return m1359nextUInta8DCA5k(nextUInt, 0, until);
    }

    /* renamed from: nextUInt-a8DCA5k, reason: not valid java name */
    public static final int m1359nextUInta8DCA5k(Random nextUInt, int from, int until) {
        Intrinsics.checkNotNullParameter(nextUInt, "$this$nextUInt");
        m1354checkUIntRangeBoundsJ1ME1BU(from, until);
    ...
    public static final int nextUInt(Random $this$nextUInt, UIntRange range) {
        ...
        return Integer.compare(range.getLast() ^ Integer.MIN_VALUE, (-1) ^ Integer.MIN_VALUE) < 0 ? m1359nextUInta8DCA5k($this$nextUInt, range.getFirst(), UInt.m224constructorimpl(range.getLast() + 1)) : Integer.compare(range.getFirst() ^ Integer.MIN_VALUE, 0 ^ Integer.MIN_VALUE) > 0 ? UInt.m224constructorimpl(m1359nextUInta8DCA5k($this$nextUInt, UInt.m224constructorimpl(range.getFirst() - 1), range.getLast()) + 1) : nextUInt($this$nextUInt);
    }

    public static final long nextULong(Random $this$nextULong) {
        Intrinsics.checkNotNullParameter($this$nextULong, "<this>");
        return ULong.m303constructorimpl($this$nextULong.nextLong());
    }

    /* renamed from: nextULong-V1Xi4fY, reason: not valid java name */
    public static final long m1361nextULongV1Xi4fY(Random nextULong, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        return m1362nextULongjmpaWc(nextULong, 0L, until);
    }

    /* renamed from: nextULong-jmpaW-c, reason: not valid java name */
    public static final long m1362nextULongjmpaWc(Random nextULong, long from, long until) {
        Intrinsics.checkNotNullParameter(nextULong, "$this$nextULong");
        m1355checkULongRangeBoundseb3DHEI(from, until);
        ...
        return ULong.m303constructorimpl(signedResult);
    }
    ...
    public static final long nextULong(Random $this$nextULong, ULongRange range) {
        ...
        if (Long.compare(range.getLast() ^ Long.MIN_VALUE, (-1) ^ Long.MIN_VALUE) < 0) {
            return m1362nextULongjmpaWc($this$nextULong, range.getFirst(), ULong.m303constructorimpl(range.getLast() + ULong.m303constructorimpl(1 & 4294967295L)));
        }
        if (Long.compare(range.getFirst() ^ Long.MIN_VALUE, 0 ^ Long.MIN_VALUE) <= 0) {
            return nextULong($this$nextULong);
        }
        long j = 1 & 4294967295L;
        return ULong.m303constructorimpl(m1362nextULongjmpaWc($this$nextULong, ULong.m303constructorimpl(range.getFirst() - ULong.m303constructorimpl(j)), range.getLast()) + ULong.m303constructorimpl(j));
    }

    /* renamed from: nextUBytes-EVgfTAA, reason: not valid java name */
    public static final byte[] m1356nextUBytesEVgfTAA(Random nextUBytes, byte[] array) {
    ...
    public static /* synthetic */ byte[] m1358nextUBytesWvrt4B4$default(Random random, byte[] bArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        return m1357nextUBytesWvrt4B4(random, bArr, i, i2);
    }

    /* renamed from: nextUBytes-Wvrt4B4, reason: not valid java name */
    public static final byte[] m1357nextUBytesWvrt4B4(Random nextUBytes, byte[] array, int fromIndex, int toIndex) {
        Intrinsics.checkNotNullParameter(nextUBytes, "$this$nextUBytes");
        Intrinsics.checkNotNullParameter(array, "array");
    ...
    public static final void m1354checkUIntRangeBoundsJ1ME1BU(int from, int until) {
    ...
    public static final void m1355checkULongRangeBoundseb3DHEI(long from, long until) {
        if (!(Long.compare(until ^ Long.MIN_VALUE, from ^ Long.MIN_VALUE) > 0)) {
            throw new IllegalArgumentException(RandomKt.boundsErrorMessage(ULong.m297boximpl(from), ULong.m297boximpl(until)).toString());
        }
    }
}
