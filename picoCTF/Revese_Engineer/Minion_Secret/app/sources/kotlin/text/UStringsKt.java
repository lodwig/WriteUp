...
public final class UStringsKt {
    ...
    public static final String m1441toStringLxnNnR4(byte $this$toString_u2dLxnNnR4, int radix) {
    ...
    public static final String m1443toStringolVBNx4(short $this$toString_u2dolVBNx4, int radix) {
    ...
    public static final String m1442toStringV7xB4Y4(int $this$toString_u2dV7xB4Y4, int radix) {
    ...
    public static final String m1440toStringJSWoG40(long $this$toString_u2dJSWoG40, int radix) {
    ...
    public static final UByte toUByteOrNull(String $this$toUByteOrNull, int radix) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m224constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m141boximpl(UByte.m147constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String $this$toUShortOrNull, int radix) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m224constructorimpl(SupportMenu.USER_MASK) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m404boximpl(UShort.m410constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String $this$toUIntOrNull, int radix) {
        ...
        int uradix = UInt.m224constructorimpl(radix);
        int result = 0;
        for (int i = start; i < length; i++) {
            ...
            int result2 = UInt.m224constructorimpl(result * uradix);
            result = UInt.m224constructorimpl(UInt.m224constructorimpl(digit) + result2);
            if (Integer.compare(result ^ Integer.MIN_VALUE, result2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
        }
        return UInt.m218boximpl(result);
    }
    ...
    public static final ULong toULongOrNull(String $this$toULongOrNull, int radix) {
        ...
        long uradix = ULong.m303constructorimpl(i);
        long result = 0;
        int i2 = start;
        while (i2 < length) {
            int length2 = length;
            ...
            long result2 = ULong.m303constructorimpl(result * uradix);
            result = ULong.m303constructorimpl(ULong.m303constructorimpl(UInt.m224constructorimpl(digit) & 4294967295L) + result2);
        ...
        return ULong.m297boximpl(result);
    }
}
