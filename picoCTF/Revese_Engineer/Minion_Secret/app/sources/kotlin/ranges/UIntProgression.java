...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1349getProgressionLastElementNkh28Cs(start, endInclusive, step);
        this.step = step;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) UInt.m270toStringimpl(this.first)).append("..").append((Object) UInt.m270toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) UInt.m270toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m270toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1365fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
