    ...
    static final class C00441<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            while (!mutableList.isEmpty()) {
                ...
                c00441.label = 1;
                if (sequenceScope.yield(t, c00441) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
            return Unit.INSTANCE;
        ...
        public final Object invokeSuspend(Object $result) throws Throwable {
            ...
            switch (this.label) {
                case 0:
                    ...
                    c00391 = this;
                    SequenceScope $this$sequence2 = (SequenceScope) c00391.L$0;
                ...
                case 1:
                    ...
                    $this$sequence = (SequenceScope) c00391.L$0;
                    ResultKt.throwOnFailure($result);
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            ...
            while (it.hasNext()) {
                ...
                c00391.L$0 = $this$sequence;
                c00391.L$1 = it;
                c00391.I$0 = index2;
                c00391.label = 1;
                if ($this$sequence.yieldAll(c00391.$iterator.invoke(result), c00391) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                index = index2;
            }
