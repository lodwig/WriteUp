...
public final class UnsignedKt {
    ...
    public static final int m480uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m224constructorimpl((int) ((v1 & 4294967295L) / (4294967295L & v2)));
    }

    /* renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m481uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m224constructorimpl((int) ((v1 & 4294967295L) % (4294967295L & v2)));
    }

    /* renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m482ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m303constructorimpl(Long.compare(v1 ^ Long.MIN_VALUE, v2 ^ Long.MIN_VALUE) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m303constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m303constructorimpl((Long.compare(ULong.m303constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m303constructorimpl(v2) ^ Long.MIN_VALUE) < 0 ? 0 : 1) + quotient);
    }

    /* renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m483ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compare(ULong.m303constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m303constructorimpl(v2) ^ Long.MIN_VALUE) >= 0) {
            j = v2;
        }
        return ULong.m303constructorimpl(rem - j);
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        return v <= 2.147483647E9d ? UInt.m224constructorimpl((int) v) : UInt.m224constructorimpl(UInt.m224constructorimpl((int) (v - Integer.MAX_VALUE)) + UInt.m224constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double v) {
        ...
        return v < 9.223372036854776E18d ? ULong.m303constructorimpl((long) v) : ULong.m303constructorimpl(ULong.m303constructorimpl((long) (v - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
