...
public final /* data */ class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1612copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1614copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1614copyRFiDyg4(T value, long duration) {
    ...
    public int hashCode() {
        return ((this.value == null ? 0 : this.value.hashCode()) * 31) + Duration.m1483hashCodeimpl(this.duration);
    }
    ...
    public final long m1615getDurationUwyO8pc() {
        return this.duration;
    }
