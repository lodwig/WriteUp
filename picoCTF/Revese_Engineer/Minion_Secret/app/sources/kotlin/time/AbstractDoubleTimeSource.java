...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1446minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1460equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1487isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1557getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1490minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1460equalsimpl0(mo1446minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1557getZEROUwyO8pc());
        }
        ...
        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1504toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1557getZEROUwyO8pc(), null);
    }
}
