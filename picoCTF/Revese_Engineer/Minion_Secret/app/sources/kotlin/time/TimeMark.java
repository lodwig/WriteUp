...
public interface TimeMark {
    ...
    TimeMark mo1445minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1447plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1592plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1591minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1447plusLRDsOJo(Duration.m1507unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1488isNegativeimpl($this.mo1444elapsedNowUwyO8pc());
        }
