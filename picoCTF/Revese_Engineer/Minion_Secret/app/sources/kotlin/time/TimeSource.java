...
public interface TimeSource {
    ...
    public static final class Monotonic implements WithComparableMarks {
        ...
        public static final class ValueTimeMark implements ComparableTimeMark {
            ...
            public static String m1608toStringimpl(long j) {
            ...
            public String toString() {
                return m1608toStringimpl(this.reading);
            }
            ...
            public /* bridge */ /* synthetic */ ComparableTimeMark mo1445minusLRDsOJo(long duration) {
                return m1594boximpl(m1609minusLRDsOJo(duration));
            }

            @Override // kotlin.time.TimeMark
            /* renamed from: minus-LRDsOJo */
            public /* bridge */ /* synthetic */ TimeMark mo1445minusLRDsOJo(long duration) {
                return m1594boximpl(m1609minusLRDsOJo(duration));
            }

            @Override // kotlin.time.ComparableTimeMark, kotlin.time.TimeMark
            /* renamed from: plus-LRDsOJo */
            public /* bridge */ /* synthetic */ ComparableTimeMark mo1447plusLRDsOJo(long duration) {
                return m1594boximpl(m1610plusLRDsOJo(duration));
            }

            @Override // kotlin.time.TimeMark
            /* renamed from: plus-LRDsOJo */
            public /* bridge */ /* synthetic */ TimeMark mo1447plusLRDsOJo(long duration) {
                return m1594boximpl(m1610plusLRDsOJo(duration));
            }
            ...
            public static int m1596compareToimpl(long arg0, ComparableTimeMark other) {
                Intrinsics.checkNotNullParameter(other, "other");
                return m1594boximpl(arg0).compareTo(other);
            }

            /* renamed from: elapsedNow-UwyO8pc, reason: not valid java name */
            public static long m1598elapsedNowUwyO8pc(long arg0) {
                return MonotonicTimeSource.INSTANCE.m1587elapsedFrom6eNON_k(arg0);
            }
            ...
            public static long m1607plusLRDsOJo(long arg0, long duration) {
                return MonotonicTimeSource.INSTANCE.m1585adjustReading6QKq23U(arg0, duration);
            }

            /* renamed from: plus-LRDsOJo, reason: not valid java name */
            public long m1610plusLRDsOJo(long duration) {
                return m1607plusLRDsOJo(this.reading, duration);
            }

            /* renamed from: minus-LRDsOJo, reason: not valid java name */
            public static long m1605minusLRDsOJo(long arg0, long duration) {
                return MonotonicTimeSource.INSTANCE.m1585adjustReading6QKq23U(arg0, Duration.m1507unaryMinusUwyO8pc(duration));
            }

            /* renamed from: minus-LRDsOJo, reason: not valid java name */
            public long m1609minusLRDsOJo(long duration) {
                return m1605minusLRDsOJo(this.reading, duration);
            }

            /* renamed from: hasPassedNow-impl, reason: not valid java name */
            public static boolean m1602hasPassedNowimpl(long arg0) {
                return !Duration.m1488isNegativeimpl(m1598elapsedNowUwyO8pc(arg0));
            }
            ...
            public static boolean m1601hasNotPassedNowimpl(long arg0) {
                return Duration.m1488isNegativeimpl(m1598elapsedNowUwyO8pc(arg0));
            }
            ...
            public long mo1446minusUwyO8pc(ComparableTimeMark other) {
                Intrinsics.checkNotNullParameter(other, "other");
                return m1606minusUwyO8pc(this.reading, other);
            }

            /* renamed from: minus-UwyO8pc, reason: not valid java name */
            public static long m1606minusUwyO8pc(long arg0, ComparableTimeMark other) {
                Intrinsics.checkNotNullParameter(other, "other");
                if (!(other instanceof ValueTimeMark)) {
                    throw new IllegalArgumentException("Subtracting or comparing time marks from different time sources is not possible: " + ((Object) m1608toStringimpl(arg0)) + " and " + other);
                }
                return m1604minus6eNON_k(arg0, ((ValueTimeMark) other).getReading());
            }

            /* renamed from: minus-6eNON_k, reason: not valid java name */
            public static final long m1604minus6eNON_k(long arg0, long other) {
                return MonotonicTimeSource.INSTANCE.m1586differenceBetweenfRLX17w(arg0, other);
            }

            /* renamed from: compareTo-6eNON_k, reason: not valid java name */
            public static final int m1595compareTo6eNON_k(long arg0, long other) {
                return Duration.m1454compareToLRDsOJo(m1604minus6eNON_k(arg0, other), Duration.INSTANCE.m1557getZEROUwyO8pc());
            }
        }
    }
