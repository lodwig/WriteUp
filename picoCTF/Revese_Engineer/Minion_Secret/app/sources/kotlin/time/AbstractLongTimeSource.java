...
public abstract class AbstractLongTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class LongTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo1445minusLRDsOJo(long duration) {
            return ComparableTimeMark.DefaultImpls.m1450minusLRDsOJo(this, duration);
        }
        ...
        public long mo1446minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1460equalsimpl0(this.offset, ((LongTimeMark) other).offset) && Duration.m1487isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1557getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1490minusLRDsOJo(this.offset, ((LongTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((LongTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m1460equalsimpl0(startedAtDiff, Duration.m1507unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m1557getZEROUwyO8pc() : Duration.m1491plusLRDsOJo(startedAtDiff, offsetDiff);
        }
        ...
        public final long m1448effectiveDurationUwyO8pc$kotlin_stdlib() {
            ...
            long offsetSeconds = Duration.m1476getInWholeSecondsimpl(arg0$iv);
            int offsetNanoseconds = Duration.m1478getNanosecondsComponentimpl(arg0$iv);
            ...
            long jM1491plusLRDsOJo = Duration.m1491plusLRDsOJo(scale2, startedAtRem2);
            Duration.Companion companion2 = Duration.INSTANCE;
            long jM1491plusLRDsOJo2 = Duration.m1491plusLRDsOJo(jM1491plusLRDsOJo, DurationKt.toDuration(offsetMillis + startedAtMillis, DurationUnit.MILLISECONDS));
            Duration.Companion companion3 = Duration.INSTANCE;
            return Duration.m1491plusLRDsOJo(jM1491plusLRDsOJo2, DurationKt.toDuration(offsetSeconds, DurationUnit.SECONDS));
        }
