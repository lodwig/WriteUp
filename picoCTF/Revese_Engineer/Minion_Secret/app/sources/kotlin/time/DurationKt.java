...
public final class DurationKt {
    ...
    private static final long m1581timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1493timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1580timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1492timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }
    ...
    */
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1455constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1455constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1455constructorimpl((normalValue << 1) + unitDiscriminator);
    }
