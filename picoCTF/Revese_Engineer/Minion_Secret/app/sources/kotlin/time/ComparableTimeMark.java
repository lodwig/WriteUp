...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1445minusLRDsOJo(long duration);

    /* renamed from: minus-UwyO8pc */
    long mo1446minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1447plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1450minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1447plusLRDsOJo(Duration.m1507unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1454compareToLRDsOJo($this.mo1446minusUwyO8pc(other), Duration.INSTANCE.m1557getZEROUwyO8pc());
        }
    }
}
