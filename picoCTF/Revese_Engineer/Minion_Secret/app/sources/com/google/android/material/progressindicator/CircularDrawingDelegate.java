...
final class CircularDrawingDelegate extends DrawingDelegate<CircularProgressIndicatorSpec> {
    ...
    void fillIndicator(Canvas canvas, Paint paint, float startFraction, float endFraction, int color) {
        ...
        float startDegree = startFraction * 360.0f * this.arcDirectionFactor;
        float arcDegree = endFraction >= startFraction ? (endFraction - startFraction) * 360.0f * this.arcDirectionFactor : ((endFraction + 1.0f) - startFraction) * 360.0f * this.arcDirectionFactor;
