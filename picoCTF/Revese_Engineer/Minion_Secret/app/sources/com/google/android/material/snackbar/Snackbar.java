...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
        ...
        if (TextUtils.isEmpty(text) || listener == null) {
            ...
            tv.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.snackbar.Snackbar$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view) {
                    this.f$0.m107lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(listener, view);
                }
            });
        }
        return this;
    ...
    /* synthetic */ void m107lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener listener, View view) {
