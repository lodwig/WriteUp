...
class VersionedParcelStream extends VersionedParcel {
    ...
    @Override // androidx.versionedparcelable.VersionedParcel
    public boolean readField(int fieldId) throws IOException {
    ...
    @Override // androidx.versionedparcelable.VersionedParcel
    public void writeByteArray(byte[] b, int offset, int len) throws IOException {
        try {
            if (b != null) {
    ...
    @Override // androidx.versionedparcelable.VersionedParcel
    public void writeBundle(Bundle val) throws IOException {
        try {
            if (val != null) {
