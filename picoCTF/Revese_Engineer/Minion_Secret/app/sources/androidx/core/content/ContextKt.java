...
public final class ContextKt {
    ...
    public static final void withStyledAttributes(Context $this$withStyledAttributes, int resourceId, int[] attrs, Function1<? super TypedArray, Unit> block) throws Resources.NotFoundException {
        Intrinsics.checkNotNullParameter($this$withStyledAttributes, "<this>");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Intrinsics.checkNotNullParameter(block, "block");
