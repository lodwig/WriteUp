...
public final class TextViewCompat {
    ...
    private static Field retrieveField(String fieldName) throws NoSuchFieldException {
        Field field = null;
        try {
    ...
    private static class OreoCallback implements ActionMode.Callback {
        ...
        @Override // android.view.ActionMode.Callback
        public boolean onPrepareActionMode(ActionMode mode, Menu menu) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
