...
public class WindowInsetsCompat {
    ...
    private static class Impl20 extends Impl {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl
        void copyRootViewBounds(View rootView) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
        ...
        private Insets getVisibleInsets(View rootView) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
            if (Build.VERSION.SDK_INT >= 30) {
    ...
    private static class BuilderImpl30 extends BuilderImpl29 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        void setInsetsIgnoringVisibility(int typeMask, Insets insets) throws IllegalArgumentException {
    ...
    static class Api21ReflectionHolder {
        ...
        public static WindowInsetsCompat getRootWindowInsets(View v) throws IllegalAccessException, IllegalArgumentException {
