...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        private Bitmap reduceLargeIconSize(Bitmap icon) throws Resources.NotFoundException {
    ...
    public static abstract class Style {
        ...
        */
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public android.widget.RemoteViews applyStandardTemplate(boolean r20, int r21, boolean r22) throws android.content.res.Resources.NotFoundException {
            /*
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (srcArray == null) {
            ...
            for (int i = 0; i < srcArray.length; i++) {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    editChoicesBeforeSending = src.getEditChoicesBeforeSending();
                } else {
                    editChoicesBeforeSending = 0;
                }
                remoteInputs[i] = new RemoteInput(resultKey, label, choices, allowFreeFormInput, editChoicesBeforeSending, src.getExtras(), null);
            }
        }
