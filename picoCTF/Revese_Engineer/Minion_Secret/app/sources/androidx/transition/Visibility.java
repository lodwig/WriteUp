...
public abstract class Visibility extends Transition {
    ...
    public Animator onDisappear(final ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) throws IllegalAccessException, IllegalArgumentException {
    ...
    private static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener, AnimatorUtils.AnimatorPauseListenerCompat {
        ...
        public void onAnimationPause(Animator animation) throws IllegalAccessException, IllegalArgumentException {
            if (!this.mCanceled) {
        ...
        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorPauseListener, androidx.transition.AnimatorUtils.AnimatorPauseListenerCompat
        public void onAnimationResume(Animator animation) throws IllegalAccessException, IllegalArgumentException {
            if (!this.mCanceled) {
