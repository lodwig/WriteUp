...
class GhostViewPort extends ViewGroup implements GhostView {
    ...
    public void setVisibility(int visibility) throws IllegalAccessException, IllegalArgumentException {
    ...
    @Override // android.view.ViewGroup, android.view.View
    protected void onAttachedToWindow() throws IllegalAccessException, IllegalArgumentException {
    ...
    @Override // android.view.ViewGroup, android.view.View
    protected void onDetachedFromWindow() throws IllegalAccessException, IllegalArgumentException {
    ...
    static void copySize(View from, View to) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    static GhostViewPort addGhost(View view, ViewGroup viewGroup, Matrix matrix) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
