...
class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    static class OverlayViewGroup extends ViewGroup {
        ...
        protected ViewParent invalidateChildInParentFast(int left, int top, Rect dirty) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
