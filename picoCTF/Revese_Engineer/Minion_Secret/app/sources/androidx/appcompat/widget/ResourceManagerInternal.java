...
public final class ResourceManagerInternal {
    ...
    private Drawable createDrawableIfNeeded(Context context, int resId) throws Resources.NotFoundException {
    ...
    private Drawable loadDrawableFromDelegates(Context context, int resId) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int type;
